...
<head>
  ...
  {{ Html::Script("/js/matchbrackets.js") }}

  {{ Html::Script("/js/htmlmixed.js") }}

  {{ Html::Script("/js/xml.js") }}

  {{ Html::Script("/js/javascript.js") }}

  {{ Html::Script("/js/css.js") }}

  {{ Html::Script("/js/clike.js") }}

  {{ Html::Script("/js/php.js") }}
      ...
      <ul class="sidebar-menu">
        ...
        @foreach($linkes as $link)
          ...
          <ul class="treeview-menu">
            <li class="active"><a href='{{ url("/dashboard/$link->slug") }}'><i class="fa fa-circle-o"></i> All {{ $link->link_name }} </a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Add {{ $link->link_name }}</a></li>
          </ul>
        </li>
        @endforeach
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('show_all') }}"><i class="fa fa-table"></i> Show Tables</a></li>
            <li><a href="{{ route('get_add_table') }}"><i class="fa fa-plus"></i> Add Table</a></li>
          </ul>
        </li>
      </ul>
    </section>
